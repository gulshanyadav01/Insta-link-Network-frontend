...
const Education = ({education, deleteEducation}) => {
    const educations = education.map(exp =>(
        <div className = "bg-gulshan-dascar h-10 m-4 ml-10 shadow w-3/5 rounded flex justify-between hover:ring-2 hover:ring-red-300">
            <h1 className = "text-white  font-medium m-2">{exp.degree}</h1><hr className = "w-0.5 h-full bg-gulshan-inner"></hr>
            <h1 className = "text-white font-medium m-2">{exp.school}</h1><hr className = "w-0.5 h-full bg-gulshan-inner"></hr>
            <h1 className = "text-white font-medium m-2">{exp.fieldOfStudy}</h1><hr className = "w-0.5 h-full bg-gulshan-inner"></hr>
    ...
    return (
        <div>
            ...
            <div className = "w-2/5 ml-12  flex justify-between">
