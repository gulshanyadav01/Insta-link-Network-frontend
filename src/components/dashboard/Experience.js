...
const Experience = ({experience, deleteExperience}) => {
    ...
    const experiences = experience.map(exp =>(
        ...
        <div className = "bg-gulshan-dascar h-10 m-4 ml-10  shadow w-3/5 rounded flex justify-between">
            <h1 className = "text-limegreen-400 font-medium m-2">{exp.company}</h1><hr className = "w-0.5 h-full bg-gulshan-inner"></hr>
            <h1 className = "text-limegreen-400 font-medium m-2">{exp.title}</h1><hr className = "w-0.5 h-full bg-gulshan-inner"></hr>
            <h1 className = "text-limegreen-400 font-medium m-2">{exp.from.toString()}</h1><hr className = "w-0.5 h-full bg-gulshan-inner"></hr>
    ...
    return (
        <div>
            ...
            <div className = "w-2/5 ml-10  flex justify-between">
