...
const DashboardAction = () => {
    return (
        <div className = "flex w-3/5 m-6 justify-between">
            <div className = "w-40  h-16 bg-gulshan-dascar m-4 shadow-lg rounded">
            ...
            <div className = "w-40  h-16 bg-gulshan-dascar  m-4 ml-2 shadow-lg rounded">
